       ...
       <div className={`left-side ${leftSide ? 'active' : ''}`}>
            ...
            <div className="side-wrapper">
                ...
                <div className="side-menu">
                    ...
                    <a href="#">
                        <svg stroke="currentColor" strokeWidth="2" fill="none" 
                            strokeLinecap="round" viewBox="0 0 24 24">
            ...
            <div className="side-wrapper">
                ...
                <div className="side-menu">
                    ...
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path d="M176.6 360l-51.1-24.2-26-12.3L155.1 187l35.5-8.8s-58 97.4-14 181.9z"
                                fill="#f8b40e" />
                            ...
                            <path
                                ...
                                fill="#1d2c30" />
                            <path d="M146.1 107.4h-16a8.1 8.1 0 00-8 8V179c0 4.5 3.6 8.1 8 8.1h16v-79.6z"
                                fill="#a0d9f2" />
            ...
            <a href="https://twitter.com/AysnrTrkk" className="follow-me" target="_blank">
                <span className="follow-text">
                    <svg viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" 
                        strokeLinecap="round" className="css-i6dzq1">
                        <path
                        ...
                        <div className="album box">
                            <div className="status-main">
                                ...
                                <div className="album-detail">
                                    <div className="album-title"><strong>Quan Ha</strong> create new <span>album</span>
                                    </div>
                            ...
                            <div className="album-actions">
                                ...
                                <a href="#" className="album-action">
                                    <svg stroke="currentColor" strokeWidth="2" fill="none" 
                                        strokeLinecap="round" className="css-i6dzq1" viewBox="0 0 24 24">
